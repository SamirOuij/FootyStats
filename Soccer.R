...
#####
#Select the players you want to see. Choose 4 players for better visual results.
...
#run the radial profile function with std=T, which standardizes the data so that the scale looks normal
